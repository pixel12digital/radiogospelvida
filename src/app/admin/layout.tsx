  ...
  return (
    <div className="flex min-h-screen bg-[#fff8f0]">
      ...
      <aside className="w-72 bg-white text-[#a85b1a] flex flex-col items-center py-8 shadow-lg border-r border-[#ffe6b3]">
        <div className="mb-10">
          <Image src="/images/logo.webp" alt="Logo Rádio Gospel Vida" width={100} height={100} className="rounded-full border-4 border-[#a85b1a] shadow-lg" />
        </div>
        <nav className="flex flex-col gap-3 w-full px-4">
          ...
          <Link href="/admin/agendamento" className="py-3 px-4 rounded-lg hover:bg-[#ffe6b3] hover:text-[#1a0d0a] font-semibold transition">Programação</Link>
          ...
          <Link href="/admin/documentacao" className="py-3 px-4 rounded-lg hover:bg-[#ffe6b3] hover:text-[#1a0d0a] font-semibold transition">Documentação</Link>
